		...
		swal({
			...
			content             : (
				<div>
					...
					<Divider hidden />
					<Button color="yellow" size="huge" onClick={() => this.redirectToUserProfileCloseSwal()}>
						<div className="text">Your profile</div>
					</Button>
					<Divider hidden />
					<Button color="purple" size="huge" onClick={() => this.redirectToMovingHomeCloseSwal()}>
						<div className="text">Moving home?</div>
					</Button>
					<Divider hidden />
					<Button color="red" size="huge" onClick={() => this.logOutCloseSwal()}>
