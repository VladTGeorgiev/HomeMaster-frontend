...
import { Button, Form, Grid, Header, Image, Message, Segment, Dropdown, Label, Divider, Icon } from 'semantic-ui-react';
import userlogo from '../media/smile (1).png';
import userleaving from '../media/xx.png';
import legal from '../media/file.png';

const Profile = ({ user, updateUser, deleteUser, redirectToCookiePolicy, width }) => {
	const options = [
	...
	if (isMobile) {
		return (
			<Grid textAlign="center" style={{ height: '80vh' }} verticalAlign="middle" columns={1} relaxed="very">
				<Grid.Column style={{ maxWidth: 450 }}>
					...
					>
						<Segment stacked>
							...
							<Label>
								{' '}
								<div>Cookie Policy Agreement:</div>
								<Dropdown
									onChange={(e) => setCookiePolicy()}
									defaultValue={user.cookie_policy}
									options={options}
								/>
							</Label>
							<Divider hidden />
							<Button color="teal" fluid size="large" type="submit">
								<div className="comfortaa">Submit</div>
							</Button>
						</Segment>
					</Form>
				</Grid.Column>
				...
				<Grid.Column style={{ maxWidth: 450 }}>
					...
					<Message>
						<Button onClick={() => deleteUser()} color="red" fluid size="large" type="submit">
							<div className="comfortaa">Delete your profile</div>
						</Button>
					</Message>
					<Divider hidden />
					<Header as="h4" color="teal" textAlign="center">
					...
					<Message>
						<Button
							...
							type="submit"
						>
							<div className="comfortaa">View our Cookie Policy</div>
						</Button>
					</Message>
				</Grid.Column>
			</Grid>
