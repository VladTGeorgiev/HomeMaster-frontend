	...
	render () {
		...
		return (
			<Card onClick={this.props.showDetails}>
				...
				<Card.Content>
					<Card.Header>
						<div className="text-home-name">{home.name}</div>
					</Card.Header>
					<Divider hidden />
					<Card.Meta>
				...
				<Button color="teal" fluid size="small" onClick={() => redirectToHomeProfile()}>
					<div className="comfortaa">Change home details</div>
				</Button>
			</Card>
		);
	}
