					...
					<Grid.Column style={{ width: '90vw' }}>
						...
						<Table.Body>
							...
							<Table.Row>
								...
								<Table.Cell />
								<Table.Cell>
									{neededEssentials.map((essential) => (
										<p>
											<Checkbox
												toggle
												checked={essential.more}
												onChange={() => updateEssential(essential)}
											/>
										</p>
									))}
								</Table.Cell>
								...
								<Table.Cell>
									{neededEssentials.map((essential) => (
										<Button
											...
											fluid
											size="small"
											onClick={(e) => buyFromAmazon(e, essential.name)}
										>
											<div className="comfortaa">Amazon</div>
										</Button>
									))}
								</Table.Cell>
							</Table.Row>
							...
							<Table.Row>
								...
								<Table.Cell />
								<Table.Cell>
									{notNeededEssentials.map((essential) => (
										<p>
											<Checkbox
												toggle
												checked={essential.more}
								...
								<Table.Cell>
									{notNeededEssentials.map((essential) => (
										<Button
											...
											fluid
											size="small"
											onClick={(e) => removeEssential(e, essential)}
										>
											<div className="comfortaa">Remove</div>
										</Button>
									))}
								</Table.Cell>
							</Table.Row>
						...
						<Button color="pink" size="medium" onClick={() => addNewEssential()}>
							<div className="comfortaa">Add more items</div>
						</Button>
					</Grid.Column>
				</Grid>
			);
									...
									<Table.Cell>
										{neededEssentials.map((essential) => (
											<Button
												...
												onClick={(e) => buyFromAmazon(e, essential.name)}
											>
												<div className="comfortaa">Buy from Amazon</div>
											</Button>
										))}
									</Table.Cell>
								</Table.Row>
